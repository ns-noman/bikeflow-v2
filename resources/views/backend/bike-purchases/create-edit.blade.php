                                        ...
                                        <div class="col-12 mt-4">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-sm-3 col-md-3 col-lg-3">
                                                    ...
                                                    <select class="form-control  @error('bike_type') is-invalid @enderror" name="bike_type" id="bike_type" required @readonly(isset($data['sale_id']))>
                                                        <option disabled selected value=''>Select Bike Type</option>
                                                        <option @selected((isset($data['item']) || isset($data['sale_id'])) && $data['bike']['bike_type'] == 0) value="0">Used Bike</option>
                                                        <option @selected((isset($data['item']) || isset($data['sale_id'])) && $data['bike']['bike_type'] == 1) value="1">New Bike</option>
                                                    </select>
                                                    @error('manufacture_year')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
