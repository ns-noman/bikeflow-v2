                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-sm table-striped table-bordered table-centre">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <th>Profit Shared</th>
                                                            <td id="bike_profit_shared_amt"></td>
                                                        </tr>
                                                        <tr>
                                                            <th>Net Bike Sales Profit</th>
                                                            <td id="net_bike_sales_profit"></td>
                                                        </tr>
                                                        <tr>
                                                            <th>Regular Sales Profit</th>
    ...
    function loadAssetData() {
        $.ajax({
                ...
                success: function(res){
                    ...
                    let net_bike_sales_profit = parseFloat(res.bike_sales) - parseFloat(res.bike_profit_shared_amt);

                    $('#bike_sale_profit').html(formatNumber(res.bike_sales || 0));
                    $('#bike_profit_shared_amt').html(formatNumber(res.bike_profit_shared_amt || 0));
                    $('#net_bike_sales_profit').html(formatNumber(net_bike_sales_profit || 0));
