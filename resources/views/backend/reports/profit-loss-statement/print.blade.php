                              ...
                              <div class="col-12 table-responsive">
                                  <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <th>Bike Sales Profit</th>
                                            <td id="bike_sale_profit">{{ $data['basicInfo']['currency_symbol'] }} {{ $data['lists']['bike_sales'] ?? 0 }}</td>
                                        </tr>
                                        <tr>
                                            <th>Profit Shared</th>
                                            <td id="bike_profit_shared_amt">{{ $data['basicInfo']['currency_symbol'] }} {{ number_format(($data['lists']['bike_profit_shared_amt'] ?? 0), 2) }}</td>
                                        </tr>
                                        <tr>
                                            @php
                                                $net_bike_sales_profit = $data['lists']['bike_sales'] - $data['lists']['bike_profit_shared_amt'];
                                            @endphp
                                            <th>Net Bike Sales Profit</th>
                                            <td id="net_bike_sales_profit">{{ $data['basicInfo']['currency_symbol'] }} {{ number_format(($net_bike_sales_profit ?? 0), 2) }}</td>
                                        </tr>
                                        <tr>
                                            <th>Regular Sales</th>
