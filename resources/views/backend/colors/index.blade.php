        ...
        $(document).ready(function(){
            ...
            options.columns = 
                    [
                        ...
                        { 
                            data: null, 
                            name: 'colors.hex_code', 
                            orderable: true, 
                            searchable: false, 
                            render: function(data, type, row, meta) {
                               return `<span class="badge" style="background-color: ${row.hex_code};color: black; text-shadow: 2px 0px 8px white;">${row.hex_code}</span>`;
                            }
                        },
                        { 
                            data: null, 
                        ...
                        { 
                            ...
                            searchable: false, 
                            render: function(data, type, row, meta) {
                                let edit = `{{ route('colors.edit', ":id") }}`.replace(':id', row.id);
                                let destroy = `{{ route('colors.destroy', ":id") }}`.replace(':id', row.id);
